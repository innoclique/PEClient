...
export class ClientRevenueInfoComponent {
    ...
    constructor(
        ...
        this.detailCellRendererParams = ReportTemplates.psaClientRevenueInfoColumnDefs.detailCellRendererParams;
    ...
    private createClientRowData() {
        ...
        for (let i = 0; i < 50; i++) {
            ...
            rowData.push({
                name: RefData.ResellerFirstNames[i % RefData.ResellerFirstNames.length] + ' ' + RefData.ResellerLastNames[i % RefData.ResellerLastNames.length],
    ...
    getPsaClientRevenueInfoColumnDefs() {
        return ReportTemplates.psaClientRevenueInfoColumnDefs.columnDefs;
    }
    ...
    private setHeaderNames() {
        var columnDefs = this.getPsaClientRevenueInfoColumnDefs();
