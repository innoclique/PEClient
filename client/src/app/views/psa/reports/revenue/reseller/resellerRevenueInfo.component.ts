...
export class ResellerRevenueInfoComponent {
    ...
    constructor(
        ...
        this.detailCellRendererParams = ReportTemplates.psaResellerRevenueInfoColumnDefs.detailCellRendererParams;
    ...
    private createClientRowData() {
        ...
        for (let i = 0; i < 50; i++) {
            ...
            rowData.push({
                ...
                reSellerName: RefData.ResellerFirstNames[i % RefData.ResellerFirstNames.length] + ' ' + RefData.ResellerLastNames[i % RefData.ResellerLastNames.length],
    ...
    getPsaResellerRevenueInfoColumnDefs() {
        return ReportTemplates.psaResellerRevenueInfoColumnDefs.columnDefs;
    }
    ...
    private setHeaderNames() {
        var columnDefs = this.getPsaResellerRevenueInfoColumnDefs();
