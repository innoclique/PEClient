export default class RefData {
    ...
    static ResellerFirstNames = ["Sophie", "Isabelle", "Emily", "Olivia", "Lily", "Chloe", "Isabella"];
    static ResellerLastNames = ["Gunner","Hayden", "Hudson", "Hunter", "Jacoby", "Jagger",
     "Jaxon", "Jett", "Kade", "Kane","Keating", "Keegan", "Kingston", "Kobe"];
    static firstNames = [
    ...
    static usageTypes = ["Employees", "Licence"];
    static paymentTypes = ["Monthly","Yearly"];
    static evaluationTypes = ["Year-End"];
    static evaluationPeriod = ["JAN","FEB","MAR","APR","MAY","JUN","JUL","AUG","SEP","OCT","NOV","DEC"];
