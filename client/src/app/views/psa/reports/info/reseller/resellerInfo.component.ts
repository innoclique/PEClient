...
export class ResellerInfoComponent {
    ...
    constructor(
        ...
        this.detailCellRendererParams = ReportTemplates.psaResellerInfoColumnDefs.detailCellRendererParams;
    ...
    private createResellerRowData() {
        ...
        for (let i = 0; i < 50; i++) {
            ...
            rowData.push({
                ...
                children: this.createClientRowData()
    ...
    getPsaResellerInfoColumnDefs() {
        return ReportTemplates.psaResellerInfoColumnDefs.columnDefs;
    }
