    ...
    private createResellerClientRowData(resellerClientsInfo: any) {
        ...
        for (let i = 0; i < resellerClientsInfo.length; i++) {
            rowData.push({
                ...
                evaluationPeriod: ReportTemplates.months[resellerClientsInfo[i].StartMonth] + "'" + ReportTemplates.getYearStart(ReportTemplates.months[resellerClientsInfo[i].StartMonth]) + ' To ' +  resellerClientsInfo[i].EndMonth.substring(0, 3) + "'" + ReportTemplates.getYearEnd( resellerClientsInfo[i].EndMonth.substring(0, 3)),
